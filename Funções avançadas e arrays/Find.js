// const lista = [1,2,3,4,5,6,7,8,9,3,4,5,6,7,2,8,9,0];
...
// const valorTotal = armarioteste.reduce((valorPrevio, proximoValor) => {
...
// const descricaoTodosItens = armario4.reduce((prev, next) => {
//     if (!prev.length) return next.tipo
//     return `${prev}, ${next.tipo}`
// }, '');
// console.log(descricaoTodosItens);

//método find, retorna sempre o primeiro item que corresponde a condição.
const armario = [
    {name: 'camisetas', cor: 'azul'},
    {name: 'bermudas', cor: 'azul'},
    {name: 'pijamas', cor: 'verde'},
    {name: 'calças', cor: 'verde'},
]
console.log(armario.find((item) => {
